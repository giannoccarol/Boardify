...
export const AI_PROVIDERS: AiProviderDef[] = [
  ...
  { id: "opencode-go", name: "OpenCode Go", envVar: "OPENCODE_API_KEY", hint: "Provider OpenCode Go", apiStyle: "openai-chat", baseUrl: "https://opencode.ai/zen/go/v1", keyRequired: true, vision: true, modelsEndpoint: "openai", suggestedModels: ["kimi-k2.7-code", "kimi-k2.6", "deepseek-v4-flash", "glm-5.2", "mimo-v2.5"] },
