...
export type AiApiStyle = "openai-chat" | "anthropic" | "gemini" | "opencode-go";
...
export const AI_PROVIDERS: AiProviderDef[] = [
  ...
  { id: "opencode", name: "OpenCode Zen", envVar: "OPENCODE_API_KEY", hint: "Provider OpenCode Zen", apiStyle: "openai-chat", baseUrl: "https://opencode.ai/zen/v1", keyRequired: true, vision: true, modelsEndpoint: "openai", suggestedModels: ["big-pickle", "claude-sonnet-4-5", "gpt-5.5", "gemini-3-flash", "deepseek-v4-flash", "kimi-k2.6"] },
  { id: "opencode-go", name: "OpenCode Go", envVar: "OPENCODE_API_KEY", hint: "Provider OpenCode Go", apiStyle: "opencode-go", baseUrl: "https://opencode.ai/zen/go/v1", keyRequired: true, vision: true, modelsEndpoint: "openai", suggestedModels: ["kimi-k2.7-code", "kimi-k2.6", "deepseek-v4-flash", "glm-5.2", "mimo-v2.5"] },
